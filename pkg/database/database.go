...
func Setup() error {
	...
	switch driver {
	case "sqlite":
		db, err = gorm.Open(sqlite.Open("sample.db"), &gorm.Config{Logger: newDBLogger, SkipDefaultTransaction: true, NamingStrategy: schema.NamingStrategy{SingularTable: true}})
	case "mysql":
